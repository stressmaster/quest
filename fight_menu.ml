...
let render_menu (fight : State.fight) =
  if fight.player_health <= 0 then
    Font.render_font
      (Font.new_font "you lose" 0.6 1. !Magic_numbers.get_magic.width
    ...
    Render.render_square
      (Render.new_square
         ...
         (!Magic_numbers.get_magic.width *. 4.)
         (!Magic_numbers.get_magic.height *. 4.)
    ...
    if fight.attacking then (
      ...
      Font.render_font
        (Font.new_font fight.monster_string 0. 0.3
           !Magic_numbers.get_magic.width
           !Magic_numbers.get_magic.height) );
    Font.render_font
      (Font.new_font fight.input_string 0. 0.1
         !Magic_numbers.get_magic.width !Magic_numbers.get_magic.height);
    Font.render_font
      (Font.new_font
         ("hp " ^ string_of_int fight.monster_health)
         0.8 1.6 !Magic_numbers.get_magic.width
         !Magic_numbers.get_magic.height);
    Font.render_font
      (Font.new_font
         ("hp " ^ string_of_int fight.player_health)
         0.1 0.6 !Magic_numbers.get_magic.width
         !Magic_numbers.get_magic.height);
    if not fight.attacking then (
      Font.render_font
        (Font.new_font "fight" 0.1 0.2 !Magic_numbers.get_magic.width
           !Magic_numbers.get_magic.height);
      Font.render_font
        (Font.new_font "heal" 0.88 0.2 !Magic_numbers.get_magic.width
           !Magic_numbers.get_magic.height);
      Font.render_font
        (Font.new_font "run" 1.6 0.2 !Magic_numbers.get_magic.width
           !Magic_numbers.get_magic.height);
      match fight.action with
      | Attack ->
          Font.render_font
            (Font.new_font ">" 0. 0.2 !Magic_numbers.get_magic.width
               !Magic_numbers.get_magic.height)
      | Recover ->
          Font.render_font
            (Font.new_font ">" 0.78 0.2 !Magic_numbers.get_magic.width
               !Magic_numbers.get_magic.height)
      | Run ->
          Font.render_font
            (Font.new_font ">" 1.5 0.2 !Magic_numbers.get_magic.width
               !Magic_numbers.get_magic.height) )
  end
  else
    Font.render_font
      (Font.new_font "you win" 0.6499 1. !Magic_numbers.get_magic.width
         !Magic_numbers.get_magic.height)
