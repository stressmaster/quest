...
(* [init_walker xmin xmax ymin ymax start] is a walker that walks within
   the rectangluar bounds as specified by [xmin, [xmax], [ymin], [ymax]
   and starts walking from the coordinate [start]*)
